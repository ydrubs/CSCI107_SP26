"""
In this program we explore how to control access to attributes and methods from the user.

We explore using how to use attribute/method hiding and getter/setter methods.
"""
