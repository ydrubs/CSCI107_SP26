...
greater_then_50 = {}
# greater_then_50['thing'] = 5
# print(greater_then_50)

for key, value in numbers.items():
    if value > 50:
        greater_then_50[key] = value
print(greater_then_50)

just_over_50 = [i for i in numbers.values() if i > 50]
print(just_over_50)

letter = [i for i in numbers.keys() if numbers[i] in just_over_50]
print(letter)
